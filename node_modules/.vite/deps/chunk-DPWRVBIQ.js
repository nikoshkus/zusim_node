...
function getOwnerWindow(node) {
  var _a7, _b5;
  return isElement(node) ? (_b5 = (_a7 = getOwnerDocument(node)) == null ? void 0 : _a7.defaultView) != null ? _b5 : window : window;
}
function getOwnerDocument(node) {
  var _a7;
  return isElement(node) ? (_a7 = node.ownerDocument) != null ? _a7 : document : document;
}
...
function createIcon(options) {
  ...
  const path = import_react17.Children.toArray(options.path);
...
react/cjs/react-jsx-runtime.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-DPWRVBIQ.js.map
