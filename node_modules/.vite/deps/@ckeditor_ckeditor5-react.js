  ...
  "node_modules/@ckeditor/ckeditor5-react/dist/index.js"(exports, module) {
    !function(t, e) {
      ...
      return (() => {
        ...
        const f = l || p || Function("return this")();
        const _ = function() {
          return f.Date.now();
        };
        var y = /\s/;
        ...
        const S = function(t3) {
          return "symbol" == typeof t3 || T(t3) && "[object Symbol]" == W(t3);
        };
        ...
        const F = function(t3, e3, r3) {
          var o2, n2, i2, s2, a2, c2, u2 = 0, h2 = false, l2 = false, p2 = true;
          ...
          function b2(t4) {
            return a2 = void 0, p2 && o2 ? f2(t4) : (o2 = n2 = void 0, s2);
          }
          function v2() {
            var t4 = _(), r4 = y2(t4);
            if (o2 = arguments, n2 = this, c2 = t4, r4) {
              if (void 0 === a2)
                return function(t5) {
                  return u2 = t5, a2 = setTimeout(g2, e3), h2 ? f2(t5) : s2;
                }(c2);
              if (l2)
                return clearTimeout(a2), a2 = setTimeout(g2, e3), f2(c2);
            }
            return void 0 === a2 && (a2 = setTimeout(g2, e3)), s2;
          }
          return e3 = M(e3) || 0, d(r3) && (h2 = !!r3.leading, i2 = (l2 = "maxWait" in r3) ? U(M(r3.maxWait) || 0, e3) : i2, p2 = "trailing" in r3 ? !!r3.trailing : p2), v2.cancel = function() {
        ...
        const Tt = function(t3) {
          var e3 = Wt(this, t3).delete(t3);
          return this.size -= e3 ? 1 : 0, e3;
        };
        const St = function(t3) {
          return Wt(this, t3).get(t3);
        };
        const Rt = function(t3) {
          return Wt(this, t3).has(t3);
        };
        const It = function(t3, e3) {
          var r3 = Wt(this, t3), o2 = r3.size;
        ...
        Dt.prototype.clear = Pt, Dt.prototype.delete = Tt, Dt.prototype.get = St, Dt.prototype.has = Rt, Dt.prototype.set = It;
        const zt = Dt;
        ...
        const Vt = function(t3) {
          return T(t3) && "[object Arguments]" == W(t3);
        };
        var Kt = Object.prototype, Qt = Kt.hasOwnProperty, Gt = Kt.propertyIsEnumerable;
        const Yt = Vt(function() {
          return arguments;
        }()) ? Vt : function(t3) {
          return T(t3) && Qt.call(t3, "callee") && !Gt.call(t3, "callee");
        };
        const Jt = Array.isArray;
        const Xt = function() {
          return false;
        };
        var Zt = "object" == typeof exports && exports && !exports.nodeType && exports, te = Zt && "object" == typeof module && module && !module.nodeType && module, ee = te && te.exports === Zt ? f.Buffer : void 0;
        ...
        const ae = function(t3) {
          return T(t3) && ie(t3.length) && !!se[W(t3)];
        };
        ...
        var pe = le && le.isTypedArray;
        const fe = pe ? ce(pe) : ae;
        var _e = Object.prototype.hasOwnProperty;
        const ye = function(t3, e3) {
          var r3 = Jt(t3), o2 = !r3 && Yt(t3), n2 = !r3 && !o2 && re(t3), i2 = !r3 && !o2 && !n2 && fe(t3), s2 = r3 || o2 || n2 || i2, a2 = s2 ? Ht(t3.length, String) : [], c2 = a2.length;
          for (var u2 in t3)
        ...
        const Te = function(t3, e3) {
          return t3 && $t(e3, We(e3), t3);
        };
        var Se = "object" == typeof exports && exports && !exports.nodeType && exports, Re = Se && "object" == typeof module && module && !module.nodeType && module, Ie = Re && Re.exports === Se ? f.Buffer : void 0, De = Ie ? Ie.allocUnsafe : void 0;
        ...
        const Ye = _t(f, "DataView");
        const Je = _t(f, "Promise");
        const Xe = _t(f, "Set");
        const Ze = _t(f, "WeakMap");
        var tr = "[object Map]", er = "[object Promise]", rr = "[object Set]", or = "[object WeakMap]", nr = "[object DataView]", ir = st(Ye), sr = st(yt), ar = st(Je), cr = st(Xe), ur = st(Ze), hr = W;
        (Ye && hr(new Ye(new ArrayBuffer(1))) != nr || yt && hr(new yt()) != tr || Je && hr(Je.resolve()) != er || Xe && hr(new Xe()) != rr || Ze && hr(new Ze()) != or) && (hr = function(t3) {
          var e3 = W(t3), r3 = "[object Object]" == e3 ? t3.constructor : void 0, o2 = r3 ? st(r3) : "";
          if (o2)
            switch (o2) {
              case ir:
                return nr;
        ...
        const Pr = function(t3) {
          return T(t3) && "[object Map]" == dr(t3);
        };
        var Ar = le && le.isMap;
        const Wr = Ar ? ce(Ar) : Pr;
        const Tr = function(t3) {
          return T(t3) && "[object Set]" == dr(t3);
        };
        var Sr = le && le.isSet;
        const Rr = Sr ? ce(Sr) : Tr;
        ...
        const Ur = function t3(e3, r3, o2, n2, i2, s2) {
          ...
          if (l2) {
            ...
            var p2 = dr(e3), f2 = p2 == Dr || "[object GeneratorFunction]" == p2;
            if (re(e3))
              return ze(e3, c2);
            if (p2 == zr || p2 == Ir || f2 && !i2) {
              if (a2 = u2 || f2 ? {} : Cr(e3), !c2)
                return u2 ? Ve(e3, Te(a2, e3)) : ke(e3, Oe(a2, e3));
            } else {
              if (!Mr[p2])
                return i2 ? e3 : {};
              a2 = xr(e3, p2, c2);
          ...
          }) : Wr(e3) && e3.forEach(function(n3, i3) {
            a2.set(i3, t3(n3, r3, o2, i3, e3, s2));
          });
          var y2 = l2 ? void 0 : (h2 ? u2 ? Ge : Qe : u2 ? We : Ee)(e3);
        ...
        const Hr = function(t3) {
          return T(t3) && 1 === t3.nodeType && !$r(t3);
        };
        class Vr extends a {
          constructor(t3, e3 = {}) {
        ...
        class to extends e2().Component {
          ...
          shouldComponentUpdate(t3) {
            return !!this.editor && (t3.id !== this.props.id || (t3.disableWatchdog !== this.props.disableWatchdog || (this._shouldUpdateEditor(t3) && this.editor.data.set(t3.data), "disabled" in t3 && (t3.disabled ? this.editor.enableReadOnlyMode(Zr) : this.editor.disableReadOnlyMode(Zr)), false)));
          }
          ...
          async _initializeEditor() {
            await this.editorDestructionInProgress, this.props.disableWatchdog ? this.instance = await this._createEditor(this.domContainer.current, this._getConfig()) : this.watchdog || (this.context instanceof Qr ? this.watchdog = new eo(this.context) : this.watchdog = new to._EditorWatchdog(this.props.editor, this.props.watchdogConfig), this.watchdog.setCreator((t3, e3) => this._createEditor(t3, e3)), this.watchdog.on("error", (t3, { error: e3, causesRestart: r3 }) => {
        ...
        to.contextType = Jr, to.propTypes = { editor: i().func.isRequired, data: i().string, config: i().object, disableWatchdog: i().bool, watchdogConfig: i().object, onChange: i().func, onReady: i().func, onFocus: i().func, onBlur: i().func, onError: i().func, disabled: i().bool, id: i().any }, to._EditorWatchdog = Vr;
        class eo {
          constructor(t3) {
